...
Ujistěte se, že máte povolený modul `obrazky.tex`. Ten poskytuje podporu pro grafiku a příkaz `\img`, kterým lze obrázky vkládat. Povinnými parametry jsou popisek a cesta k souboru, volitelně lze potom specifikovat výšku, resp. velikost.
```tex
