...
% Zakladni informace jako kdo je autorem, jaky je nazev prace apod. Pokud je
% autorem zena, potom je nutne v souboru `sablona.tex` nahradit "Vypracoval:"
% za "Vypracovala:". Toto bude v budoucnu osetreno lepe.
